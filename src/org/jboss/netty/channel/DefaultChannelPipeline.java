...
public class DefaultChannelPipeline implements ChannelPipeline {
    ...
    private ChannelHandler replace(DefaultChannelHandlerContext ctx, String newName, ChannelHandler newHandler) {
        if (ctx == head) {
            ...
            if (!removed && !added) {
            	Log.w(this.getClass().getName(), removeException.toString());
            	Log.w(this.getClass().getName(), addException.toString());
    ...
    private void callAfterAdd(ChannelHandlerContext ctx) {
        ...
        try {
            ...
            try {
            	...
            	Log.w(this.getClass().getName(), "Failed to remove a handler: " + ctx.getName());
            }
    ...
    public void sendUpstream(ChannelEvent e) {
        ...
        if (head == null) {
        	Log.w(this.getClass().getName(), "The pipeline contains no upstream handlers; discarding: " + e);
            return;
        }
    ...
    protected void notifyHandlerException(ChannelEvent e, Throwable t) {
        if (e instanceof ExceptionEvent) {
        	Log.w(this.getClass().getName(), "An exception was thrown by a user handler " +
        ...
        try {
        	...
        	Log.w(this.getClass().getName(), "An exception was thrown by an exception handler.", e1);
        }
    }
    ...
    private static final class DiscardingChannelSink implements ChannelSink {
        ...
        public void eventSunk(ChannelPipeline pipeline, ChannelEvent e) {
        	Log.w(this.getClass().getName(), "Not attached yet; discarding: " + e);
        }
